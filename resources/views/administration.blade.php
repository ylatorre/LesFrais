...
<div class="flex items-end align-center" style="height: 42px;">
                                        <input type="date"  name="dateChevauxFiscaux" id="dateChevauxFiscaux" class="block h-full text-sm text-gray-900 border border-gray-300 rounded-lg align-center bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"  value="{{$user->dateChevauxFiscaux}}"
                                              autofocus></div>
    ...
    <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full ">
        <div class="relative w-full h-full max-w-4xl p-4 md:h-auto">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <form class="space-y-6" action="{{ route('ajoutUser') }}" method="post" >
                        ...
                        <div class="flex items-end justify-between">
                            ...
                            <div class="flex items-end align-center" style="height: 42px;">
                                <input type="date"  name="dateChevauxFiscaux" id="dateChevauxFiscaux" class="block h-full text-sm text-gray-900 border border-gray-300 rounded-lg align-center bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"  value="{{date("Y-m-d")}}"
                                       autofocus></div>
