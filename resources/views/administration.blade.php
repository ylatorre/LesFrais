                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class=" flex justify-center">
                                ...
                                <button
                                    class="block mr-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                    type="button" data-modal-toggle="authentication-modal{{ $i }}">
                                    Modifier
                                </button>
                                <button
                                    class="block text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form class="space-y-6" action="{{ route('ajoutUser') }}" method="post">
                        ...
                        <div class="flex justify-between items-end">
                            ...
                            <div class="flex align-center items-end" style="height: 42px;">
                                <input type="date" name="dateCheveuxFiscaux" id="dateCheveuxFiscaux"
                                    class="align-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block h-full  dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
