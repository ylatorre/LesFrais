<x-app-layout>
    ...
    @elseif(Auth::user()->superadmin == 1)
        <div class="w-full h-20 px-4 mb-6 font-bold margin">Note de frais de {{ $utilisateurs[0]->name }} pour le mois
            : {{ $utilisateurs[0]->mois }}
                ...
                <div>
                    <table class="tablepdf">
                        <thead>
                            ...
                            <th class="TH-table text-center BGblue" style="border-left: 2px solid black">Dt TVA (20%)
                            </th>
                            ...
                            @foreach ($utilisateurs as $utilisateur)
                                <tr>
                                    ...
                                    <td class="TD-table col-table text-center"
                                        style="overflow:hidden; border-bottom:2px solid black">
                        ...
                        <tr>
                            ...
                            <td class="TD-table text-center" colspan="9" style="font-size: 16px !important;">Total
                                {{ $total }} € TTC</td>
                        </tr>
