...
<body>
    ...
    <div class="signature">
        <table class="table-footer">
            ...
            <tr>
                <td>
                    <a href="https://www.facebook.com/carpeDiem.itservicestelecom" target="_blank"> <img src="{{ asset('./images/iconFacebook.png') }}" alt="fb" width="24px"></a>
                    <a href="https://twitter.com/Carpe_Diem_Pro" target="_blank"> <img src="{{ asset('./images/Twitter-b@5x.png') }}" alt="tw" width="24px"></a>
                    <a href="https://www.linkedin.com/company/carpe-diem-informatique/" target="_blank"> <img src="{{ asset('./images/Linkedin-b@5x.png') }}" alt="ln" width="24px"></a>
                    <a href="https://www.youtube.com/channel/UCTI2dHTGS9VrwKxGJf5MW7A" target="_blank"> <img src="{{ asset('./images/Youtube-b@5x.png') }}" alt="yt" width="24px"></a>
                    <a href="https://www.carpediem.pro/" target="_blank"> <img src="{{ asset('./images/Link-b@5x.png') }}" alt="link" width="24px"></a>
                </td>
